        ...
        <div class="formulario">
            <form action="ValidaDesempateHumanas.php" method="post">
                <div class="texto">
                    ...
                    <input type="radio" name="PerguntaDesempate1" value ='Mark' id = "Pergunta1.1"><label for="Pergunta1.1" class = "Respostas">a) Criando estratégias de marketing para promover destinos turísticos ou serviços relacionados.</label><br>
                    ...
                    <input type="radio" name="PerguntaDesempate2" value ='Mark' id = "Pergunta2.1"><label for="Pergunta2.1" class = "Respostas">a) Análise de mercado, identificação de tendências e desenvolvimento de campanhas promocionais.</label><br>
                    ...
                    <input type="radio" name="PerguntaDesempate3" value ='Mark' id = "Pergunta3.1"><label for="Pergunta3.1" class = "Respostas">a) Criar estratégias inovadoras para atrair turistas e aumentar a visibilidade de destinos.</label><br>
